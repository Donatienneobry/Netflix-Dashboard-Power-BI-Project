...
![Countries Insight](https://github.com/Donatienneobry/Netflix-Dashboard-Power-BI-Project/raw/Development-don/neflix_project_countries_3.PNG)

![Cast & Directors](https://github.com/Donatienneobry/Netflix-Dashboard-Power-BI-Project/raw/Development-don/neflix_project_casts_4.PNG)
...
## Objectives
- Analyze the distribution and evolution of Netflix titles by country.
- Highlight the most popular genres and content types by region.
- Identify the most prolific directors and actors featured on Netflix.
- Extract key insights to support data-driven decision-making.

---

## Key Insights
- The analysis covers 8,803 titles, 124 countries, and 37 genres.
- The United States, India, and the United Kingdom have the most Netflix titles.
- Movies account for 70% of the catalog, with TV shows making up 30%.
- The genres Action/Adventure and Drama dominate in most regions.
- Directors such as Rajiv Chilaka and Steven Spielberg are among the most active on the platform.
...
| **Visualization** | Types	Maps, Bar Charts, Pie Charts, Treemaps |

---

## Power BI Skills Demonstrated
- Data cleaning and transformation
- Modeling relationships between countries, content, and casts
- Creating KPIs for quick insights
- Interactive visualization of global content distribution
...
- Distribution of Titles and Leading Genres
- Major Casts and Directors
- Final KPI Summary

---

## Business Impact
- This dashboard could allow Netflix, analysts, and decision-makers to:
